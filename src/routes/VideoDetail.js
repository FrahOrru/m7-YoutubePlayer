    ...
    return (
        <div className="glass video-detail">
            <div className="backtoHome">
                <img src="https://img.icons8.com/material-outlined/24/FFFFFF/left.png" alt="back" onClick={backToHome}/>
            </div>
            ...
            {
                isChanging ? 
                <div className="center"><LoadingMotion /></div> :
                <div className="video-player">
                    ...
                    <div className="video-right">
                        <VideoList isChangingPage={reload} research={searchText}></VideoList>
                    </div>           
                </div>
            }
        </div>
